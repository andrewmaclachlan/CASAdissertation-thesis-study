...
![writing gif](libs/img/phdwrite.gif)
...
knitr::include_graphics('libs/img/heading_styles.png') 
```
* Use numbered headings
```{r echo=FALSE, out.width = "300pt", fig.align='center'}
knitr::include_graphics('libs/img/headings.png') 
```
---
# Captions
...
knitr::include_graphics('/libs/img/caption.PNG', error=FALSE) 
```

* Automatically cross reference them in the text<sup>1</sup>

```{r echo=FALSE, out.width = "200pt", fig.align='center'}
knitr::include_graphics('libs/img/cross-reference.png') 
```
...
```{r echo=FALSE, out.width = "300pt", fig.align='center'}
knitr::include_graphics('libs/img/table_of_contents.png') 
```
*AND table of tables

```{r echo=FALSE, out.width = "300pt", fig.align='center'}
knitr::include_graphics('libs/img/table_of_tables.png') 
```
...
```{r echo=FALSE, out.width = "200pt", fig.align='center'}
knitr::include_graphics('libs/img/header_chapter_name.png') 
```
...
```{r echo=FALSE, out.width = "200pt", fig.align='center'}
knitr::include_graphics('libs/img/page_number_format.png') 
```
...
```{r echo=FALSE, out.width = "300pt", fig.align='center'}
knitr::include_graphics('libs/img/page_break.png') 
```
